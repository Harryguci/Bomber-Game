...
public class RenderPixel {
    ...
    public static RenderPixel WALL01 = new RenderPixel(ImageReader.Read("tiles\\tilemap_packed.png"), 4);
    ...
    public static void main(String[] args) {
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                BufferedImage img = RenderPixel.WALL01.getSubEnlargedSpriteSheet(cl, r);
